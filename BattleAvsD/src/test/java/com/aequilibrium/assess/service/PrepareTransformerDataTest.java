...
import com.aequilibrium.assess.service.impl.TransformerServiceImpl;
...
public class PrepareTransformerDataTest {
    ...
    public void prepareTransformerDataInMap() {
        ...
        TransformerServiceImpl tfdf = TransformerServiceImpl.getInstance();

        Transformer tf1 = new Transformer();
        Long lg = TransformerServiceImpl.getCounter().getAndIncrement();
        tf1.setId(lg);
        ...
        tf1.setFirepower(6);
        tf1.setSkill(10);
        tf1 = tfdf.createTransformer(tf1);

        Transformer tf2 = new Transformer();
        lg = TransformerServiceImpl.getCounter().getAndIncrement();
        tf2.setId(lg);
        ...
        tf2.setFirepower(9);
        tf2.setSkill(7);
        tf2 = tfdf.createTransformer(tf2);
        ...
        tf3.setFirepower(4);
        tf3.setSkill(4);
        tf3 = tfdf.createTransformer(tf3);
