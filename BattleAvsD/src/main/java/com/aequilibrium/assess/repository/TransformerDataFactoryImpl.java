...
@Repository
// @ApplicationScope
public class TransformerDataFactoryImpl implements TransformerDataFactory {

    private static TransformerDataFactoryImpl instance = null;

    private TransformerDataFactoryImpl() {
        prepareTransformerDataInMap();
    }

    private static synchronized void syncInit() {
        if (instance == null) {
            instance = new TransformerDataFactoryImpl();
        }
    }

    public static TransformerDataFactoryImpl getInstance() {
        if (instance == null) {
            syncInit();
        }
        return instance;
    ...
    @Override
    public Transformer createTransformerInMap(Transformer tf) {
    ...
    @Override
    public Transformer updateTransformerInMap(Transformer tf) {
        Long id = tf.getId();
        this.transformerMap.put(id, tf);
        return tf;
    }
    ...
    @Override
    public boolean deleteTransformerToMap(Long id) {
    ...
    @Override
    public boolean deleteTransformerByNameToMap(String name) {
        boolean successDelete = false;
    ...
    @Override
    public Transformer getTransformerByIdFromMap(Long id) {
        Transformer tf = null;
        for (Long key : transformerMap.keySet()) {
            if (key.equals(id)) {
    ...
    @Override
    public Transformer getTransformerByNameFromMap(String name) {
        Transformer tf = null;
        for (Long key : transformerMap.keySet()) {
    ...
    @Override
    public ArrayList<Transformer> getAllTransformerFromMap() {
     ...
     */
    @Override
    public Map<String, Object> checkWinner(int battles) {
